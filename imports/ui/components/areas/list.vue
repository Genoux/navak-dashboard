<template name="areas">
  <div class="bg-gray-dark pb-24">
      ...
      <div class="lg:flex-2">
        <div class="lg:flex grid grid-cols-3">
          <input
            class="
              rounded-sm
              lg:mr-5 lg:pt-0 lg:pb-0 lg:mb-0
              bg-black
              text-white
              pl-2
              border
          ...
          />
          <div class="lg:mr-5 lg:mb-0 lg:ml-0 ml-4">
            <v-dropdown
              class="w-full"
              CustomClass="h-full"
              style="height: 34px"
    ...
    <div
      v-if="areas.length > 0 && this.selected === 'All'"
    ...
    >
      <div
        @click="closeDialog"
        class="absolute w-full h-screen bg-dark opacity-75"
      ></div>
      <div
        class="
          bg-black
      ...
      >
        ...
        >
          ...
          <div class="h-full">
            ...
            <v-dropdown
              style="height: 42px"
              CustomClass="w-full px-4 py-2 h-full"
              :setAll="false"
              :selection="snapList"
    ...
    async createNewPosition(elm) {
      ...
      try {
        ...
        await this.$http.post(
          `http://${this.$param.api}/api/areas/`,
          this.defaultValue
        );
        this.openNotification(
          "top-center",
          "success",
          `👍 Succelfully created position ${elm.name}`,
          "You can check the changes in the list"
        );
        this.loading = false;
        this.closeDialog();
