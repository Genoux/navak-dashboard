		...
		<div class="flex flex-col lg:flex-row bg-dark border-b border-white border-opacity-20 pt-5 lg:pb-5 md:pb-5 pb-8 pl-5 pr-5">
			...
			<div class="lg:flex-2">
				<div class="lg:flex grid grid-cols-3">
					<input
						class="rounded-sm h-8 lg:mr-5 lg:pt-0 lg:pb-0 lg:mb-0 bg-black text-white pl-2 border lg:pr-10 pr-0 focus:outline-none placeholder-white text-sm placeholder-opacity-50 select"
						type="text"
						v-model="search"
